...
//     quoteTitle: string;
//     documents?: ExpenseItem[]; // optional now
//     expenseType: string;
//     projectId: string;
//   };
...
//   // Pick data based on expenseType
...
//     data = materialRes.data || [];
//     isLoading = materialRes.isLoading;
//     isError = materialRes.isError;
//   } else if (expenseType === "Subcontractor") {
//     data = subcontractorRes.data || [];
...
//       <ExpenseTable
//         title={expenseType} // better to pass expenseType as title for form logic
//         expenses={data.map((item, index) => ({ ...item, id: index + 1 }))}
//       />
//     </div>
//   );
// };
